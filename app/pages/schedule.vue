...
async function generateSchedule() {
  ...
  try {
    ...
    const response = await $fetch(`/api/schedule/${hall.value.value}?${params}`)
...
.input-card:hover {
  ...
  box-shadow: 0 8px 24px rgba(179, 136, 255, 0.1) !important;
}
...
.schedule-card:hover {
  ...
  box-shadow: 0 12px 32px rgba(179, 136, 255, 0.15) !important;
}
